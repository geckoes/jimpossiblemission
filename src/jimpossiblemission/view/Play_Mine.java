...
public class Play_Mine extends JPanel implements Observer
{
    ...
    public void update(Observable o, Object arg)
    {
        ...
        switch (arg) {
            case Result result -> navigator.navigate(switch (result) {
                case Loss -> Screen.Loss;
                case Victory -> Screen.Victory;
                case Terminated -> Screen.Menu;
            });
            case Duration duration -> time.setText("time: " + duration.toSeconds() + "s");
            case Tile tile -> {
