...
import jimpossiblemission.model.Tile.Visibility;
        ...
        switch (visibility) {
            ...
            case Revealed -> {
                ...
                boolean allEmptyRevealed = Stream.of(tiles)
                        .allMatch(t -> t.isMine || t.visibility() == Visibility.Revealed);

                boolean allMinesFlagged = Stream.of(tiles)
                        .allMatch(t -> !(t.isMine ^ t.visibility() == Visibility.Flagged));
